...
if not opt then
   ...
   cmd:option('-test', 'test_classify.t7', 'the path to the test data')
   cmd:option('-input_dim', 63, 'the input size')
   cmd:option('-model_path', '../results/neg_vot_measurement_dimitrieva_2_layers/fold_1/model.net', 'the path to the model') 
