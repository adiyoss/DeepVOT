...
_WebResourceData_WebResourceMIMEType_WebResourceTextEncodingName_WebResourceFrameName^WebResourceURLO"}<html><head><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">----------------------------------------------------------------------
...
</pre></body></html>Ztext/plainUUTF-8P_Phttps://raw.githubusercontent.com/torch/tutorials/master/2_supervised/1_data.lua    ( : P n Ö î## #&#'                           #z