...
if not opt then
   ...
   cmd:text()
   cmd:text('Options:')
   cmd:option('-input_dir', '/Users/yossiadi/Datasets/vot/natalia/features/multi_vot/test/', 'the path to the dir where the data files are placed (in a .txt format)')
   cmd:option('-output_file', 'data/multi_class/test.t7', 'the path to save the t7 binary file')
