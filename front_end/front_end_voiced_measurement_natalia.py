    ...
    for item in os.listdir(audio_path):
        if item.endswith('.wav'):
            try:
                ...
                start_extract = textgrid._TextGrid__tiers[0]._IntervalTier__intervals[0]._Interval__xmin
                end_extract = textgrid._TextGrid__tiers[0]._IntervalTier__intervals[2]._Interval__xmax
